...
$config['sess_cookie_name'] = 'ep_session'; //default ci_session
$config['sess_expiration'] = 0; //default 7200
$config['sess_save_path'] = APPPATH.'cache'; //default NULL
$config['sess_match_ip'] = FALSE; //default FALSE
$config['sess_time_to_update'] = 300;///default 300
$config['sess_regenerate_destroy'] = FALSE; //default FALSE
...
|
*/
$config['cookie_prefix']	= 'ep'; //default ''
