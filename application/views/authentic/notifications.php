    ...
    <div class="row">
        <div class="col s4 m4 l4">
            <ul class="collection with-header">
                ...
                <li class="collection-item"><div>Slideshow Images<a href="#banner" class="secondary-content"><i class="material-icons">perm_media</i></a></div></li>
                                            ...
                                            echo '<ul class="collection">';
                                             foreach($prayerrequests as $request):
                                                ...
                                                echo '<p class="secondary-content">
                                                        <a href="#preply" onmouseenter="setpemail(\''.$request['email'].'\')" class="tooltipped modal-trigger" data-position="bottom" data-delay="30" data-tooltip="Reply this request"><i class="material-icons">reply_all</i></a>
